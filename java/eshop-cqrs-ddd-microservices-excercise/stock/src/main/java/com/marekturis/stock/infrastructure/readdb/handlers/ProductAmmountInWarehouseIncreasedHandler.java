 ...
 */
@Named
public class ProductAmmountInWarehouseIncreasedHandler implements EventHandler {

	private final JDBCConnectionProvider connectionProvider;

	public ProductAmmountInWarehouseIncreasedHandler(ReadDbJDBCOptions jdbcOptions) {
		this.connectionProvider = new JDBCConnectionProvider(jdbcOptions);
	}

	@Override
	public String eventToHandle() {
		return ProductAmmountInWarehouseIncreased.class.getSimpleName();
	}
